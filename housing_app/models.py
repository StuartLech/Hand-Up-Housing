...
class Listing(models.Model):
    ...
    income_requirement = models.CharField(
        max_length=20, choices=INCOME_CHOICES, blank=True, null=True
    )
    ...
    criminal_record_allowed = models.CharField(
        max_length=12, choices=CRIMINAL_RECORD_CHOICES, default="none"
    )
...
class ActivityLog(models.Model):
    ...
    listing = models.ForeignKey(
        Listing, null=True, blank=True, on_delete=models.SET_NULL
    )
